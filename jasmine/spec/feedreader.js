...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('are name not empty', function() {
            expect(allFeeds).toBeDefined();
            allFeeds.forEach(function (feed) {
    ...
    describe('New Feed Selection', function() {
        ...
        it('feed content should change after loading feed', function(done) {
            loadFeed(1, function() {
                $loadedFeed = $('.feed').html();
                expect($loadedFeed).not.toEqual($initialFeed);
                done();
            });
        });
    });
